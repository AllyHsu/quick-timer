...
var start, isBlink, isLight, isRun, isShow, isWarned, handler, latency, stopBy, delay, audioRemind, audioEnd, fgColor, bgColor, volumeLevel, newAudio, soundToggle, applyColors, openFgPicker, openBgPicker, setForeground, setBackground, setVolume, show, adjust, toggle, reset, blink, count, run, resize;
start = null;
isBlink = false;
isLight = true;
isRun = false;
...
applyColors = function(){
  return $('#timer').css('color', fgColor).css('background', bgColor);
};
openFgPicker = function(){
  return $('#fg-color-picker').click();
};
openBgPicker = function(){
  return $('#bg-color-picker').click();
};
...
blink = function(){
  isBlink = true;
  isLight = !isLight;
  return $('#timer').css('color', isLight ? fgColor : '#f00');
};
count = function(){
  var tm, diff;
  tm = $('#timer');
